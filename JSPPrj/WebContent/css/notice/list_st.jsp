...
<%@page import="com.newlecture.web.service.NoticeService_st"%>
...
<%
   ...
   NoticeService_st noticeService = new NoticeService_st();
   /* List<Notice> list = noticeService.getList(p, f, q); */
   List<Notice> list = NoticeService_st.getNoticeList(page_, field, query);
%>
				...
				<main id="main">
					<section>
						...
						<section class="page-status mt-3">
							...
							<%
								int count = NoticeService_st.getNoticeCount(field, query);
