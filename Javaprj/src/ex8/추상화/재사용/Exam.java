...
//		math = 10;
	...
	public abstract int total(); //자식클래스에서 완성해달라는 표시로 추상메소드로 표현
	
	public abstract float avg(); //자식클래스에서 완성해달라는 표시로 추상메소드로 표현
	
	//art shift s -> r
	
	public int getEng() { //get->멤버변수의 값을 반환하는역할
		return eng;		  //은닉된 멤버변수의 값을 읽는 방법
	}

	public void setEng(int eng) { //set 매개변수에 지정된 값을 검사하여 조건에 맞는 값일때만 멤버변수의 값을 변경
		this.eng = eng;			  //멤버 변수에 값을 넣는 방법
	}
